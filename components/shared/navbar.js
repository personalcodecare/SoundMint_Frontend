        ...
        <div className="wrapper flex justify-between items-center">
          <div className="flex items-center">
            ...
            <ul className="text-white hidden xl:flex items-center ml-8 relative space-x-6">
              ...
              <li onMouseEnter={() => setDropDownOpen(false)}>
                <Link href="/roadmap">
                  <a title="roadmap" className="text-sm hover:text-brightGreen">
                    Roadmap
                  </a>
                </Link>
              </li>
                ...
                <Link href="/rarity">
                  <a title="Rarity" className="font-bold hover:text-brightGreen">
                    ...
                    <li onClick={() => {
                      ...
                      <Link href="/roadmap">
                        <a title="roadmap" className="font-bold hover:text-brightGreen">
                          Roadmap
                        </a>
                      </Link>
                    </li>
                    <li onClick={() => {
                      ...
                      <Link href="/vinyl">
                        <a title="vinyl" className="">
                        <div className=''>
                            <span className='font-bold hover:text-brightGreen'>Vinyl</span>
                        </div>
                        </a>
                      </Link>
                    </li>                    
